...
Future<void> createTextPost(
    BuildContext context, String title, String message, String username) async {
  print("Title: $title, Message: $message, Username: $username");
  try {
    var response = await http.post(
...
Future<void> dislikePost(
  ...
  print("Om Shahane ${responce.statusCode}");
  if (responce.statusCode == 200) {
