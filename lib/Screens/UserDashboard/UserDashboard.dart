...
class _UserDashboardState extends State<UserDashboard> {
  ...
  Future<void> _shareToWhatsApp(int postIndex, BuildContext context) async {
    ...
    final String message =
        'Check out this amazing content on Social Greet! You don\'t want to miss this one!\n$postUrl';
    final String imageUrl =
        'https://socialgreet.com/images/post.jpg'; // URL to the image

    try {
      // Share a message and an image
      await Share.share(
        message,
        subject: 'Awesome content on Social Greet!',
        sharePositionOrigin: Rect.fromLTWH(0, 0, 100, 100),
        // This can include an image URL to be shared along with the message
        // WhatsApp should automatically handle the sharing of the image if it's a URL
      );

      // If you want to launch WhatsApp directly:
