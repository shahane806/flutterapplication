...
class _UserDashboardState extends State<UserDashboard> {
  ...
  Future<void> _loadInitialData() async {
    await _fetchInitialProfilePics();
  ...
  Future<void> _fetchInitialProfilePics() async {
    if (_cachedPosts == null) {
      final posts = await fetchPosts();
      _cachedPosts = posts;
    }
    for (var post in _cachedPosts!) {
      await _fetchUserProfilePic(post['phone']);
    }
  }
                ...
                child: _cachedPosts == null
                    ...
                    : _cachedPosts!.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              _fetchUserProfilePic(_cachedPosts![index]['phone']);
                              return _buildPostItem(context, index, _cachedPosts!);
                            },
                          ),
              ),
            ),
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          onTap: (index) {
            ...
            if (index == 1) {
              ...
              _disposeVideoControllers(); // Clean up before navigating
              Navigator.push(
                context,
                MaterialPageRoute(
                ...
                // Reinitialize data when returning
                _loadInitialData();
              });
            }
          },
...
class _CommentsBottomSheetState extends State<CommentsBottomSheet> {
  ...
  void _refreshComments() {
    setState(() {
      _commentsFuture =
          fetchComments(context, widget.postId.toString(), widget.phone);
    });
  }
