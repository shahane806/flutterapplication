...
import 'showSearchBottomSheet.dart';
...
class _UserDashboardState extends State<UserDashboard> {
  ...
  Widget _buildPostItem(BuildContext context, int index, List<dynamic> posts) {
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: Colors.grey[100], // Option 1: Light grey
          // Uncomment for Option 2: Subtle gradient
          // gradient: LinearGradient(
        ...
        child: Column(
          ...
          children: [
             GestureDetector(
              onTap: () => _viewMedia(context, post['postPath'], post['postType'] == 'video'),
              child: Container(
                height: MediaQuery.of(context).size.height * 0.4,
                width: double.infinity,
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: post['postType'] == 'video'
                        ? NetworkImage(post['postPath'])
                        : NetworkImage(post['postPath']),
                    fit: BoxFit.cover,
                  ),
                ),
  ...
  void _showCommentsBottomSheet(BuildContext context, int postIndex) {
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        ...
        color: Colors.white, // Background for whole sheet
        child: Column(
          ...
          children: [
            ...
            Divider(
                height: 1,
                color: Colors.grey[300]), // New divider above Container
            Container(
              width: double.infinity,
              color: Colors.white, // Swapped from blue to white
              padding: EdgeInsets.only(
                bottom: MediaQuery.of(context).viewInsets.bottom +
                    MediaQuery.of(context).size.height *
                        0.02, // Bottom: keyboard + 0.02
                left: MediaQuery.of(context).size.width * 0.02,
                right: MediaQuery.of(context).size.width * 0.02,
                top: MediaQuery.of(context).size.height * 0.015, // Top: 0.015
              ),
              child: Row(
                children: [
                  CircleAvatar(
 ...
 void _viewMedia(BuildContext context, String url, bool isVideo) {
    ...
    showDialog(
      context: context,
      builder: (context) => Dialog(
        child: isVideo ? Container() : _buildImageViewer(context,url),
      ),
    );
  }
