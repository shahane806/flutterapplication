...
import 'package:flutter_application_frontend/Screens/UserDashboard/Components/LikeButton.dart';
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          LikeButton(postId: post['id'], postPath: post['postPath'], postType:post['postType'], phone: post['phone']),
                          ShaderMask(
